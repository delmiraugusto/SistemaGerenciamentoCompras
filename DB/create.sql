...
CREATE TABLE IF NOT EXISTS Purchase ( id INTEGER PRIMARY KEY AUTOINCREMENT, userID INTEGER, orderDate DATETIME, total DECIMAL(10, 2) NOT NULL, FOREIGN KEY (userID) REFERENCES User(id) ON DELETE CASCADE);
